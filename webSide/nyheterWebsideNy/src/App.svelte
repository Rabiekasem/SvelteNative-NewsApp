...
<main id="main">
    ...
    <div id="news">
	    ...
	    <div id="downloadApp">
	        <h1>Download our <span id="span">App</span></h1>
	    </div>
	</div>	
</main>
...
<section id="contactSec">
    <form id="contactForm" on:submit|preventDefault ={sendForm}>
		...
		<div class="txtb">
	        ...
	        <input type="text" bind:value={phone} placeholder="Enter your phone.Nr" required>
	    </div>
